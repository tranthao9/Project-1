	...
	public class FormLopSinhVien
	{
		...
		public void Nhap()
		{
			...
			do
			{
				...
				Console.WriteLine("*************************************************************************************");
				Console.WriteLine();
				Console.WriteLine("Nhập mã sinh viên : "); Console.SetCursorPosition(20, 5); int ma = int.Parse(Console.ReadLine());
				if(BL.ExistKTSV(ma))
				{
					Console.Clear();
					...
					Console.WriteLine("*************************************************************************************");
					Console.WriteLine();
					Console.WriteLine("\t\t\t\t\t\t\t\t1.Sinh viên bảo lưu ");
					Console.WriteLine("\t\t\t\t\t\t\t\t2.Sinh viên chuyển lớp");
					Console.WriteLine("\t\t\t\t\t\t\t\t3.Sinh viên nghỉ học ");
					Console.WriteLine("\t\t\t\t\t\t\t\t0.exit");
					Console.WriteLine();
					Console.WriteLine("\t\t\t\t\t\t\t\tChọn tình trạng sinh viên : "); int a = int.Parse(Console.ReadLine());
					switch (a)
					{
						case 1:
				...
				while(true)
				{
					...
					Console.SetCursorPosition(20, 7); s.Namhocbdau = Console.ReadLine();
					string[] a = s.Namhocbdau.Split('-');
					if (!(s.Namhocbdau.Contains('-')) )
					{

						Console.SetCursorPosition(0,9); Console.WriteLine("Định dạng sai,vui lòng nhập lại ! VD: 2008-2009 ");
