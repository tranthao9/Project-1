						...
						if (Bl.GetAllData()[i].MaGV == ma)
						{
							...
							switch (mode)
							{
								case 1:
									...
									while (true)
									{
										Console.SetCursorPosition(80, 10); Console.Write(Bl.GetAllData()[i].TenGV);
										Console.SetCursorPosition(80, 13); Console.Write(Bl.GetAllData()[i].Gioitinh);
										Console.SetCursorPosition(80, 16); Console.Write("{0:d}", Bl.GetAllData()[i].Namsinh);
										...
										int tg = Project_1.Utility.Congcu.Ma(80, 7, 50, 28, Bl.GetAllData()[i].MaGV, 8, "Nhập sai dữ liệu mã sinh viên gồm 8 chữ số và khác 0 vui lòng nhập lại ! ");
										SinhVien m = new SinhVien(tg, Bl.GetAllData()[i].TenGV, Bl.GetAllData()[i].Namsinh, Bl.GetAllData()[i].Gioitinh, Bl.GetAllData()[i].Diachi, Bl.GetAllData()[i].SDT, Bl.GetAllData()[i].Email);
										if (Bl.Exist(tg))
										{
								...
								case 2:
									Bang();
									Console.SetCursorPosition(80, 7); Console.Write(Bl.GetAllData()[i].MaGV);
									Console.SetCursorPosition(80, 13); Console.Write(Bl.GetAllData()[i].Gioitinh);
									Console.SetCursorPosition(80, 16); Console.Write("{0:d}", Bl.GetAllData()[i].Namsinh);
									Console.SetCursorPosition(80, 19); Console.Write(Bl.GetAllData()[i].Diachi);
									Console.SetCursorPosition(80, 22); Console.Write("0" + Bl.GetAllData()[i].SDT);
									Console.SetCursorPosition(80, 25); Console.Write(Bl.GetAllData()[i].Email);
									string a = Project_1.Utility.Congcu.Ten(80, 10, 50, 28, Bl.GetAllData()[i].TenGV, "Tên sinh viên không được bỏ trống !");
								...
								case 8:
									...
									while (true)
									{
										int ma1 = Project_1.Utility.Congcu.Ma(80, 7, 50, 28, Bl.GetAllData()[i].MaGV, 8, "Nhập sai dữ liệu mã sinh viên gồm 8 chữ số và khác 0 vui lòng nhập lại ! ");
										if (Bl.Exist(ma1))
										{
											Console.SetCursorPosition(50, 28); Console.WriteLine("Mã sinh viên đã tồn tại vui lòng nhập mã khác ");
											Console.SetCursorPosition(80, 7); Console.WriteLine("                          ");
										...
										{
											string tV = Project_1.Utility.Congcu.Ten(80, 10, 50, 28, Bl.GetAllData()[i].TenGV, "Tên sinh viên không được bỏ trống !");
